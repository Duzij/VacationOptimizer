...
- Integrate a custom md to html rendering on build via vite/tsc or runtime markdown-it rendering to that content end up in html for SEO and social sharing.
...
content: |
  Markdown content here, can include headings, lists, code blocks, images, etc.
---
```
